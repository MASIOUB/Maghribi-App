...
const Home = () => {
  return (
    <div>
      {/* <div className="text-center bg-gray-50 text-primary py-24 px-6">
        <h1 className="text-5xl md:text-6xl xl:text-7xl font-bold tracking-tight mb-12">The best offer on the moroccan <br /> market</h1>
        <a className="inline-block px-7 py-3 mr-2 bg-blue-600 text-white font-medium text-sm leading-snug uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out" data-mdb-ripple="true" data-mdb-ripple-color="light" href="#!" role="button">Shop now</a>
      </div> */}

      {/* <div>
        <div className="grid-cols-3 py-20 px-10 space-y-2 lg:space-y-0 lg:grid lg:gap-3 lg:grid-rows-3">
          <div className="w-full col-span-2 row-span-2 rounded">
            <img src={decorImage} alt={"moroccan"} />
          </div>
          <div className="w-fullrounded">
            <img src={womenImage} alt={"moroccan"} />
          </div>
          <div className="w-full rounded">
            <img src={menImage} alt={"moroccan"} />
          </div>
          <div className="w-fullrounded">
            <img src={decorImage} alt={"moroccan"} />
          </div>
